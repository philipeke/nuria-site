...
def soft_ellipse_top(c, x, top, w, h, color, alpha):
    ...
    c.ellipse(x, y(top + h), x + w, y(top), stroke=0, fill=1)
    c.restoreState()
...
TERM_SECTIONS = [
    ...
    (
        ...
        "These terms govern participation in the Program and supplement any Nuria app terms, privacy notices, store terms, and written program instructions. The marketing flyer is a summary only. If a flyer, email, message, landing page, or dashboard conflicts with these terms, these terms control the Ambassador relationship unless Nuria has expressly agreed otherwise in writing.",
    ),
    (
        "3",
        "Definitions",
        "Subscription means a paid recurring subscription to the Nuria mobile app sold through the Apple App Store or Google Play. Gross Revenue means the amount charged to the subscriber before store deductions. Net Revenue means the amount actually received by Nuria after Apple or Google platform fees and mandatory store deductions. Referred Subscriber means a first-time subscriber attributed to the Ambassador code by the relevant store or Nuria attribution system. Accrued Balance means unpaid Ambassador Share accumulated over time.",
    ),
    (
        "4",
        "Eligibility and enrolment",
        "The Ambassador must be at least 18 years old, legally permitted to enter commercial arrangements, and legally able to receive payments in their country of residence. Enrolment becomes effective only when Nuria issues a unique ambassador code, partner record, or written confirmation. Nuria may refuse, pause, or revoke enrolment where identity, payment, compliance, brand, or store-policy concerns arise.",
    ),
    (
        "5",
        "Referral attribution",
        "A subscription is attributed only where the subscriber uses the Ambassador code or attribution link in a way that Nuria or the relevant store can verify. Attribution may fail if the subscriber enters the wrong code, subscribes through an unsupported flow, uses a previously existing account, cancels before the paid period begins, or where the app store does not provide sufficient data. Store attribution records, Nuria backend records, and fraud checks are the controlling source for referral status.",
    ),
    (
        "6",
        "Ambassador share",
        "The Ambassador is entitled to 50% of Net Revenue generated by each valid Referred Subscriber for each active billing cycle, including renewals, until the subscription ends or the Ambassador relationship is terminated under these terms. Refunds, chargebacks, grace-period reversals, billing corrections, fraud findings, store adjustments, taxes collected by stores, or other negative adjustments may be deducted from current or future Accrued Balance calculations.",
    ),
    (
        "7",
        "Payout threshold and timing",
        "Payouts are released only when Accrued Balance reaches EUR 100. Below the threshold, balances carry forward without expiry while the Program remains active and the Ambassador remains in good standing. Once the threshold is crossed, Nuria aims to initiate payment within 30 days after the close of that calendar month, provided the Ambassador has supplied complete payout details and any required tax, identity, or compliance information.",
    ),
    (
        "8",
        "Currency, costs and taxes",
        "Amounts are denominated in Euro unless Nuria states otherwise. Receiving-account currency conversion is handled by the receiving bank, PayPal, Wise, or payment provider. Bank, intermediary, PayPal, Wise, SWIFT, processor, return, or rejection fees may be passed through at cost and shown on the payout statement where practical. The Ambassador acts as an independent contractor and is responsible for declaring earnings and paying any taxes, duties, social charges, VAT, or similar obligations in their own jurisdiction.",
    ),
    (
        "9",
        "Statements and records",
        "Nuria may provide monthly or periodic statements showing anonymised referred subscriber activity, gross revenue, platform fees, Net Revenue, Ambassador Share, deductions, paid amounts, and Accrued Balance. Statements are informational and may be corrected if later store data, refund data, payment errors, or compliance findings require adjustment. The Ambassador should notify Nuria within 30 days of receiving a statement if they believe it contains an error.",
    ),
    (
        "10",
        "Payment details and holds",
        "The Ambassador must provide accurate payout details and promptly update them if they change. Nuria may hold payment while payout details are incomplete, while ownership of an account is unclear, while a refund or fraud review is pending, or while legal, sanctions, store-policy, or tax checks are required. Nuria is not responsible for delays caused by incorrect payout details, receiving banks, payment providers, holidays, store reporting delays, or intermediary processing.",
    ),
    (
        "11",
        "Brand and approved use",
        "The Ambassador receives a limited, non-exclusive, revocable licence to use approved Nuria names, marks, screenshots, flyers, links, and materials solely to promote the app in a truthful and respectful manner. The Ambassador may not alter logos, imply employment, agency, partnership, ownership, religious authority, endorsement by a scholar, or guaranteed results unless Nuria has approved that claim in writing.",
    ),
    (
        "12",
        "Promotion conduct",
        "The Ambassador must comply with applicable advertising, consumer-protection, privacy, platform, app-store, email, SMS, and social-media rules. The Ambassador must clearly disclose any commercial relationship where required by law or platform rules. Prohibited conduct includes spam, misleading scarcity, fake testimonials, paid search bidding on Nuria-branded terms, incentivised installs, coupon abuse, deceptive endorsements, harassment, offensive content, or promotion in places where it would be unlawful or reputationally harmful.",
    ),
    (
        "13",
        "Confidentiality and data",
        "The Ambassador must treat non-public commercial, financial, operational, technical, product, payout, subscriber, or customer information received from Nuria as confidential and may not disclose it without prior written consent, except where required by law. The Ambassador may not attempt to identify anonymised subscriber data, collect unnecessary personal data on Nuria's behalf, or represent that they control Nuria user data.",
    ),
    (
        "14",
        "Termination and suspension",
        "Either party may terminate the Program relationship on seven days written notice by email. Nuria may suspend a code or terminate immediately for material breach, suspected fraud, abuse, store-policy risk, legal risk, non-payment details, reputational harm, or conduct conflicting with Nuria's values. On termination, the ambassador code may be deactivated and future earnings cease from the next billing cycle. Accrued amounts are settled under these terms unless forfeiture applies due to fraud, abuse, unlawful conduct, or material breach.",
    ),
    (
        "15",
        "Governing law and contact",
        f"The Program is provided as is and Nuria does not guarantee any revenue level, subscription volume, uninterrupted attribution, store approval, or availability of a specific payout method. These terms are governed by Swedish law, with disputes submitted to the competent courts of Stockholm, Sweden, unless mandatory law provides otherwise. Nuria may update the Program or these terms prospectively by publishing an updated version or notifying Ambassadors. Questions, notices, payout details, and support requests should be sent to {CONTACT_EMAIL}.",
    ),
]
...
def draw_term_card(c, x, top, w, number, title, body, dark=False):
    ...
    text_top(c, title, x + 88, top + 7, "SegoeBold", 8.8, CREAM if dark else title_color)
    body_top = top + 38
    body_end = paragraph(c, body, x + 10, body_top, w - 20, "Segoe", 7.25, 9.05, CREAM if dark else MUTED)
    return body_end + 8


def draw_terms_column(c, sections, x, top, w, dark=False):
    current_top = top
    for number, title, body in sections:
        current_top = draw_term_card(c, x, current_top, w, number, title, body, dark=dark)
        current_top += 14
    return current_top
...
def build_terms_pdf():
    ...
    pages = [
        ("Terms and Conditions", TERM_SECTIONS[0:2], TERM_SECTIONS[2:4]),
        ("Attribution and Payment", TERM_SECTIONS[4:6], TERM_SECTIONS[6:8]),
        ("Records and Promotion", TERM_SECTIONS[8:10], TERM_SECTIONS[10:12]),
        ("Legal and Contact", TERM_SECTIONS[12:14], TERM_SECTIONS[14:15]),
    ]
    total_pages = len(pages)
    for page_index, (title, left_sections, right_sections) in enumerate(pages, start=1):
        dark = page_index == 1
        draw_background(c, dark=dark)
        draw_header(c, "Ambassador Terms", page_index, total_pages, dark=dark)
        ...
        text_top(c, title, MARGIN, 106, "Bahnschrift", 30, text_color)
        if page_index == 1:
            paragraph(
                c,
        ...
        draw_terms_column(c, left_sections, MARGIN, start_top, col_w, dark=dark)
        draw_terms_column(c, right_sections, MARGIN + col_w + 18, start_top, col_w, dark=dark)
        if page_index == total_pages:
            ...
            text_top(c, COMPANY_NAME, MARGIN + 78, 716, "SegoeBold", 10.5, GREEN)
            text_top(c, f"{CONTACT_EMAIL} - {COMPANY_LOCATION}", MARGIN + 78, 733, "Segoe", 8.6, MUTED)
            text_top(c, "Edition 2026 - v1.2", PAGE_W - MARGIN - 120, 716, "Segoe", 8.6, MUTED)
...
def render_cover_and_og():
    ...
    def add_blurred_ellipse(base, box, color, blur):
    ...
    img = add_blurred_ellipse(img, (575, -78, 1260, 690), (*olive_band, 72), 46)
    img = add_blurred_ellipse(img, (-140, -90, 520, 280), (116, 125, 76, 42), 38)
    img = add_blurred_ellipse(img, (680, 88, 1200, 640), (52, 61, 36, 58), 34)
    draw = ImageDraw.Draw(img)
    ...
    shadow = Image.new("RGBA", (460, 600), (0, 0, 0, 0))
    sd = ImageDraw.Draw(shadow)
    sd.ellipse((0, 34, 452, 578), fill=(*olive_band, 82))
    sd.ellipse((46, 76, 418, 528), fill=(*olive, 64))
    shadow = shadow.filter(ImageFilter.GaussianBlur(28))
    img.paste(shadow, (704, 16), shadow)
    cover2 = cover.copy()
    cover2.thumbnail((340, 486), Image.Resampling.LANCZOS)
    frame = Image.new("RGB", (cover2.width + 18, cover2.height + 18), (248, 241, 223))
    fd = ImageDraw.Draw(frame)
    fd.rounded_rectangle((0, 0, frame.width - 1, frame.height - 1), radius=8, outline=gold, width=2)

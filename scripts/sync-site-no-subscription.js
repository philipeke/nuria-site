...
const COPY = {
  en: {
    ...
    faq_release_q: "What changed from 4.0.0 to 4.1.0?",
    faq_release_a:
      "4.0.0 added Luxury Stone (via Nuria Noor), deeper Quran and audio tools, Halqa, Qaida, Sunnat, Live Haramain, and expanded localization. 4.1.0 continues polish through release hardening, partner flows, and personalization.",
  ...
  ar: {
    ...
    faq_release_q: "ما الذي تغيّر من 4.0.0 إلى 4.1.0؟",
    faq_release_a:
      "4.0.0 أضاف Luxury Stone (عبر Nuria Noor)، أدوات قرآن وصوت أعمق، حلقة، قاعدة، سنة، الحرمين، وتوسيع اللغات. 4.1.0 يواصل التحسينات والتخصيص.",
  ...
  ur: {
    ...
    faq_release_q: "4.0.0 سے 4.1.0 میں کیا بدلا؟",
    faq_release_a:
      "4.0.0 میں Luxury Stone (Nuria Noor کے ذریعے)، گہرے Quran tools، Halqa، Qaida، Sunnat، Live Haramain، اور زبانوں کی توسیع آئی۔ 4.1.0 polish اور personalization جاری ہے۔",
  ...
  id: {
    ...
    faq_release_q: "Apa yang berubah dari 4.0.0 ke 4.1.0?",
    faq_release_a:
      "4.0.0 menambahkan Luxury Stone (via Nuria Noor), alat Quran lebih dalam, Halqa, Qaida, Sunnat, Live Haramain, dan ekspansi bahasa. 4.1.0 melanjutkan polish dan personalisasi.",
  ...
  fr: {
    ...
    faq_release_q: "Quoi de nouveau entre 4.0.0 et 4.1.0 ?",
    faq_release_a:
      "4.0.0 a ajouté Luxury Stone (via Nuria Noor), outils Coran plus profonds, Halqa, Qaida, Sunnat, Live Haramain et plus de langues. 4.1.0 poursuit le polish et la personnalisation.",
  ...
  tr: {
    ...
    faq_release_q: "4.0.0'dan 4.1.0'a ne değişti?",
    faq_release_a:
      "4.0.0 Luxury Stone (Nuria Noor ile), daha derin Kuran araçları, Halqa, Qaida, Sunnat, Canlı Haramain ve dil genişlemesi ekledi. 4.1.0 polish ve kişiselleştirmeyi sürdürüyor.",
